...
- [claude/guild-grant-scout.md](./claude/guild-grant-scout.md) - Fri 18:00 UTC (Fri morning PT) Green Goods grant scout: weekly deadline radar, window watch, and a few filtered prospects on the Growth team, with a `#funding` heartbeat and a Drive memo
