...
1. **Surface blockers early.** A 5-minute mention of "I can't get the indexer running" beats a week of stuck work.
2. **Keep work visible.** Async-only progress hides drift. A weekly synchronous touch keeps everyone honest.
3. **Build the guild.** New contributors hear what others are working on; stewards see who's active.
...
| Item | What to say |
| --- | --- |
| **Done** | What got merged or shipped since last week |
| **Doing** | What's planned for this week |
| **Blocked** | Anything that needs help, decisions, or unblocking |
| **Risks** | Known scope creep, deadline risk, or external dependencies |
...
1. Post your update in the dedicated Discord channel **before** the call starts.
2. Use the same 4-item format above.
3. Tag the project maintainer if you need their attention.
4. Watch the recording (when published) and reply to anything addressed to you.

Async is acceptable. Disappearing is not.

## What this is NOT

- Not a status report theater — keep it terse.
- Not a design review — schedule that separately.
- Not a complaint forum — surface blockers, then move on.
- Not an excuse to skip async updates between weeks.
