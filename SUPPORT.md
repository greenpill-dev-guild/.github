...
> Where to get help with Greenpill Dev Guild projects, and how we route requests.

## Quick routing

| You need... | Go here |
| --- | --- |
| Help using a guild project | The project's `README.md` and `docs/` first; then open an issue on that project's repo |
...
- **Telegram** — [join](https://t.me/+n7g-u8wYtwQ2YjVi) for ongoing async discussion
- **Discord** — [join](https://discord.gg/ZJjft2EKz7) for project-specific channels and voice calls
- **Weekly public call** — usually Wednesdays (check the Telegram/forum for the current link); open to all
- **Forum** — written guild updates and longer-form discussion

## Response expectations

We are a small, mostly volunteer guild. Reasonable expectations:
...
Each project repo carries its own `README.md` and may have its own `SUPPORT.md` that overrides this default. Check there first — they'll have specifics about test environments, deploy targets, and project-specific reviewers.
